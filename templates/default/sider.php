...
echo '
<div class="sider-box">
    <div class="sider-box-title">管理员面板 （<a href="http://youbbs.sinaapp.com/" target="_blank">官方支持</a> <a href="https://github.com/ACICFG/youBBS-ACICFG" target="_blank">定制版支持</a> ）</div>
...
<div class="sider-box">
    ...
    <li>• 支持简单Markdown，不支持HTML 或 UBB 代码</li>
    <li>• 贴图： 可直接粘贴图片地址，<br/>如 http://www.baidu.com/xxx.gif <br/>支持jpg/gif/png后缀名<br/>图片地址带有特殊字符可能导致不能正常查看<br/>为了访问安全，如果图片发布后不正常显示<br/>请联系管理员进行权限开启</li>
