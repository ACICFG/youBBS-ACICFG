...
$query_sql = "SELECT a.id,a.cid,a.uid,a.ruid,a.title,a.top,a.addtime,a.edittime,a.comments,c.name as cname,u.avatar as uavatar,u.name as author,ru.name as rauthor,u.flg as flag
